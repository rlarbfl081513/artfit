...
import BlobShowScreen from "./BlobShowScreen"
import BloUserCustomFood from "../BlobCustom/BlobUserCustomFood"
import BlobUserCustomColor from "../BlobCustom/BlobUserCustomColor"
import BlobUserCustomWaterEx from "../BlobCustom/BlobUserCustomWaterEx"
import Sketch from 'react-p5'; // Sketch 컴포넌트 임포트
import Modal from "react-modal";

Modal.setAppElement('#root'); // Modal 접근할 요소 설정
...
function CustomBlob() {
        ...
        switch (activeComponent) {
            ...
            case 'Color':
                ...
                <BlobUserCustomColor
                    ...
                    setWatercolor1={setWatercolor1}
                    setWatercolor2={setWatercolor2}
                    setIScolor1={setIScolor1}
                    setBDcolor1={setBDcolor1}
                />
                );
            case 'WaterEx':
                return (
                <BlobUserCustomWaterEx 
                ET={ET}
                setET={setET}
                W={W}
                setWT={setWT} 
    ...
    const [ET, setET] = useState(30); // 운동 시간
    const [W, setWT] = useState(500); // 물 시간
    const [CabRatio, setCabRatio] = useState(100);
    const [ProRatio, setProRatio] = useState(50);
    const [FatRatio, setFatRatio] = useState(10);

    const [defaultColor1, setDefaultColor1] = useState([161,239,144, 1]);
    const [defaultColor2, setDefaultColor2] = useState([161,239,144, 1]);
    const [Watercolor1, setWatercolor1] = useState([68,169,98, 1]);
    const [Watercolor2, setWatercolor2] = useState([32,141,65, 1]);
    const [IScolor1, setIScolor1] = useState([68,231,117, 1]);
    const [BDcolor1, setBDcolor1] = useState([212,255, 203, 1]);
    ...
    return (
        ...
        <Container>      
            <Print>
                ...
                <Modal style={customStyles} isOpen={isSecondModalOpen} onRequestClose={closeSecondModal}>
                    ...
                    <StyledPrintDiv ref={componentRef}>
                        <CardTitle>Blob Design_Art Fit</CardTitle>
            ...
            <Screen>
                <BlobShowScreen ET={ET} W={W} CabRatio={CabRatio} ProRatio={ProRatio} FatRatio={FatRatio} Default_color_1={defaultColor1}
                Default_color_2={defaultColor2} Water_color_1={Watercolor1} Water_color_2={Watercolor2} IS_color_1={IScolor1} BD_color_1={BDcolor1} />
            </Screen>
